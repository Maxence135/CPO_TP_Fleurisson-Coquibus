...
public class FenetreCadena extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(texte_intro, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));

        texte_lbl_nb_chiffres_exacts.setText("Nombre de chiffres exacts :");
        getContentPane().add(texte_lbl_nb_chiffres_exacts, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 239, 161, -1));

        texte_lbl_nb_chiffres_haut.setText("Nombre de chiffres trop haut :");
        getContentPane().add(texte_lbl_nb_chiffres_haut, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 261, -1, -1));

        texte_lbl_nb_chiffres_bas.setText("Nombre de chiffres trop bas :");
        getContentPane().add(texte_lbl_nb_chiffres_bas, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 283, 161, -1));

        texte_nb_chiffres_exacts.setText("0");
        getContentPane().add(texte_nb_chiffres_exacts, new org.netbeans.lib.awtextra.AbsoluteConstraints(188, 239, 52, -1));

        texte_nb_chiffres_haut.setText("0");
        getContentPane().add(texte_nb_chiffres_haut, new org.netbeans.lib.awtextra.AbsoluteConstraints(188, 261, 52, -1));

        texte_nb_chiffres_bas.setText("0");
        getContentPane().add(texte_nb_chiffres_bas, new org.netbeans.lib.awtextra.AbsoluteConstraints(188, 283, 52, -1));
        ...
        getContentPane().add(bouton_recommencer, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, -1, -1));
        ...
        getContentPane().add(texte_score, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 100, 50));

        texte_tentatives.setText("Tentatives");
        getContentPane().add(texte_tentatives, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 240, -1, -1));
        ...
        up_chiffre_1.setText("/\\");
            ...
            getContentPane().add(up_chiffre_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, -1, -1));
            ...
            up_chiffre_2.setText("/\\");
                ...
                getContentPane().add(up_chiffre_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, -1, -1));
                ...
                up_chiffre_3.setText("/\\");
                    ...
                    getContentPane().add(up_chiffre_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, -1, -1));
                    ...
                    up_chiffre_4.setText("/\\");
                        ...
                        getContentPane().add(up_chiffre_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, -1, -1));
                        ...
                        getContentPane().add(texte_chiffre_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 80, 90));
                        ...
                        getContentPane().add(texte_chiffre_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 80, 90));
                        ...
                        getContentPane().add(texte_chiffre_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 80, 90));
                        ...
                        getContentPane().add(texte_chiffre_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 80, 80, 90));
                        ...
                        getContentPane().add(down_chiffre_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, -1, -1));
                        ...
                        getContentPane().add(down_chiffre_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, -1, -1));
                        ...
                        getContentPane().add(down_chiffre_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 180, -1, -1));
                        ...
                        getContentPane().add(down_chiffre_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, -1, -1));
                        ...
                        getContentPane().add(bouton_tester, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 110, -1, -1));

                        texte_fin.setText("jLabel1");
                        getContentPane().add(texte_fin, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FenetreCadena().setVisible(true));
    }
